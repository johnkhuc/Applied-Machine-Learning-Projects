...
## Overview
- Use K-Nearest Neighbors to predict a data point
- Explore customer data
- Split data into training and test sets
- Create model, evaluate model using test set, use model to predict unknown value

## Highlights
![graph](https://i.gyazo.com/3ef361c73c122a15e40d58c231f2ee4a.png)
![prop](https://i.gyazo.com/fb3d999687131d1031111ad2d7c04f6f.png)
